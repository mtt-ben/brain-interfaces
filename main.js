...
const MANUAL_POINTS = [
    ...
    // Talk nodes
    { id: 't1', x: 215, y: 285, cp: { x: 0, y: -500 } },
    { id: 't2', x: 229, y: 255, cp: { x: -300, y: -500 } },
    { id: 't4', x: 237, y: 275, cp: { x: 0, y: -500 } },
    { id: 't5', x: 252, y: 240, cp: { x: -300, y: -500 } },
    { id: 't6', x: 264, y: 260, cp: { x: 0, y: -500 } },
    { id: 't7', x: 275, y: 220, cp: { x: -300, y: -500 } },
    { id: 't8', x: 290, y: 230, cp: { x: 0, y: -500 } },  
];

// Définition des connexions
const MANUAL_CONNECTIONS = [
    // Loop connections
    { from: 'loop', to: 'lt1', speed: 0.005, mode: 'ping-pong', size: 10 },
    { from: 'loop', to: 'lt2', speed: 0.004, mode: 'ping-pong', size: 10 },
    { from: 'loop', to: 'lt3', speed: 0.005, mode: 'ping-pong', size: 10 },
    { from: 'loop', to: 'lt4', speed: 0.007, mode: 'ping-pong', size: 10 },
    // Listen connections
    { from: 'listen', to: 'l1', speed: 0.002, mode: 'backward', size: 10 },
    { from: 'listen', to: 'l2', speed: 0.003, mode: 'backward', size: 10 },
    { from: 'listen', to: 'l3', speed: 0.002, mode: 'backward', size: 10 },
    { from: 'listen', to: 'l4', speed: 0.003, mode: 'backward', size: 10 },
    { from: 'listen', to: 'l5', speed: 0.003, mode: 'backward', size: 10 },
    { from: 'listen', to: 'l6', speed: 0.004, mode: 'backward', size: 10 },
    { from: 'listen', to: 'l7', speed: 0.004, mode: 'backward', size: 10 },
    // Talk connections
    { from: 'talk', to: 't1', speed: 0.003, mode: 'forward', size: 10 },
    { from: 'talk', to: 't2', speed: 0.004, mode: 'forward', size: 10 },
    { from: 'talk', to: 't4', speed: 0.005, mode: 'forward', size: 10 },
    { from: 'talk', to: 't5', speed: 0.002, mode: 'forward', size: 10 },
    { from: 'talk', to: 't6', speed: 0.002, mode: 'forward', size: 10 },
    { from: 'talk', to: 't7', speed: 0.003, mode: 'forward', size: 10 },
    { from: 'talk', to: 't8', speed: 0.004, mode: 'forward', size: 10 },
];
